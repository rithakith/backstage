...
console.log('  yarn workspace @local/backstage-plugin-wso2-api-manager-backend build');
console.log('  yarn workspace @local/backstage-plugin-catalog-backend-module-wso2-apim build');
